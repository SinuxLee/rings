...
export class MG_BaiDu extends MiniGameBase {
    ...
    getOpenId(callback) {
        ...
        let url = `https://www.youzhikong.cn/server/getopenid.aspx?appid=${this.appData.appid}&secret=${this.appData.appsecret}&js_code=${MG_BaiDu.userCode}`;
        //@ts-ignore
        swan.request({
            url:url,
    ...
    getMenuButtonWorldPos() {
        ...
        //@ts-ignore
        let menu = swan.getMenuButtonBoundingClientRect();
