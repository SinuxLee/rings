...
export default class PowerManager extends SingleBase {
  private readonly savePowerCdKey: string = 'savePowerCdKey'
  private readonly savePowerCountKey: string = 'savePowerCountKey'

  private readonly MAX_POWER_COUNT = 100
  private readonly POWER_COUNT_PRE_ADD = 10

  private readonly BASE_POWER_CD: number = 300000
